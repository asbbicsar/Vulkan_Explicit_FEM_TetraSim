...
private:
    ...
    void initWindow() {
        ...
        window = glfwCreateWindow(WIDTH, HEIGHT, "Explicit FEM Simulation", nullptr, nullptr);
    ...
    void createForceBuffer() {
        VkDeviceSize bufferSize = sizeof(Force) * physicsVerts.size();
    ...
    void createDescriptorPool() {
        ...
        poolSizes[1].descriptorCount = static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT * 3) + 4;
    ...
    void createRenderDescriptorSets() {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            VkDescriptorBufferInfo forceInfo{};
            forceInfo.buffer = forceBuffer;
            forceInfo.offset = 0;
            forceInfo.range = sizeof(Force) * physicsVerts.size();
            ...
            descriptorWrites[3].pBufferInfo = &forceInfo;
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
		...
		int subSteps = 200; // 4 -> 200, super more substeps for better convergence
		...
		pc.poissonsRatio = 0.4f;
		pc.youngsModulus = 750.0f;
        ...
        for (int step = 0; step < subSteps; step++) {
            ...
            // [Step 3] Explicit Integrate (dx를 pos와 vel에 적용)
